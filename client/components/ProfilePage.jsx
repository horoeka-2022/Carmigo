      ...
      <div className="flex flex-col justify-center items-center mt-20">
        <div>
          <div className="grid grid-rows-1 justify-items-center">
            ...
            ></img>
            <button className="bg-blue-400 border-2 border-blue-300 text-white rounded-full decoration-solid flex justify-self-center mt-4 mb-4 gap-9 px-4 py-1 border-2 w-min">
            ...
            <button className="border-solid border-2 px-4 py-1 my-5 border-white rounded-3xl text-center text-l bg-gradient-to-r from-sky-400 to-indigo-400">
